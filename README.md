...
public class TicTacToeGUI2 extends JFrame implements ActionListener {
    private final JButton[][] b = new JButton[3][3];
    private char cur = 'X';
    private final JLabel status, score;
    private final JCheckBox aiBox;
    private final JToggleButton themeToggle;
    private boolean singlePlayer = false, dark = false;
    private int xWins = 0, oWins = 0, draws = 0;
    private final Color DEFAULT_BTN_BG = new Color(240,240,240);
    private final Color WIN_COLOR = new Color(60,180,75);
